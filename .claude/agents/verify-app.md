...
- Run type checking: [docs/commands.md](../../docs/commands.md#type-checking)
- Run linting: [docs/commands.md](../../docs/commands.md#linting)
- Check for any compilation errors

### 2. Automated Tests

- Run the full test suite: [docs/commands.md](../../docs/commands.md#test)
- Note any failures and their error messages
- Check test coverage if available

### 3. Manual Verification (if applicable)

- Start the application: [docs/commands.md](../../docs/commands.md#run-dev)
